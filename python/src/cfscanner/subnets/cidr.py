...
def get_num_ips_in_cidr(cidr: str, sample_size: Union[int, float, None] = None):
    """
...
def read_cidrs_from_file(filepath: str, shuffle: bool = False, n_lines: int = None):
...
def read_cidrs(
    ...
    if os.path.isfile(url_or_path):
        ...
        cidrs = read_cidrs_from_file(url_or_path, shuffle=shuffle, n_lines=n_cidrs)
